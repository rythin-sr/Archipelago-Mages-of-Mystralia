...
test_locations = [
    ...
    LocationData(base_id + 28, LocationName.MystralWoods_DeepWoods_StrangeOldGoblin, ItemName.ForestKey),
    ...
    LocationData(base_id + 37, LocationName.TheRise_RightRunePuzzle, ItemName.TheRiseKey),
    ...
    LocationData(base_id + 40, LocationName.SkyTempleFrontDoorTorchPuzzle, ItemName.SkyTempleFrontDoorKey),
    LocationData(base_id + 41, LocationName.SkyTempleHubDetonateRock, ItemName.TwentyFiveGreenBeads),
    LocationData(base_id + 42, LocationName.SkyTempleHubEastBigKey, ItemName.SkyTempleEasternDoorKey),
    ...
    LocationData(base_id + 48, LocationName.SkyTempleUpperBigKey, ItemName.SkyTempleBossKey),
    ...
    LocationData(base_id + 83, LocationName.TombOfTheMageKing_BigKeyOne, ItemName.TombEntranceKey),
    ...
    LocationData(base_id + 87, LocationName.TombOfTheMageKing_BigKeyTwo, ItemName.TombMidKey),
    LocationData(base_id + 88, LocationName.TombOfTheMageKing_CelestialPuzzle, ItemName.Purple_Soulbead),
    LocationData(base_id + 89, LocationName.TombOfTheMageKing_BigKeyThree, ItemName.TombBossKey),
    LocationData(base_id + 90, LocationName.TombOfTheMageKing_BeamPuzzle, ItemName.Purple_Soulbead),
    LocationData(base_id + 91, LocationName.TombOfTheMageKing_BigKeyFour, ItemName.TombBossKey),
    ...
    LocationData(base_id + 95, LocationName.Graveyard_StatueBigKey, ItemName.HighlandsGraveyardKey),
    ...
    LocationData(base_id + 103, LocationName.GreyleafHamlet_SavedTheCitizens, ItemName.GreyleafHamletKey),
    ...
    LocationData(base_id + 106, LocationName.GreyleafHamletCave_AuraEssence, ItemName.Aura_Essence),
    ...
    LocationData(base_id + 118, LocationName.SunkenQuarry_AquaEssence, ItemName.Aqua_Essence),
    LocationData(base_id + 120, LocationName.OldMines_BigKey, ItemName.OldMinesKey),
    ...
    LocationData(base_id + 124, LocationName.OldMines_GaeaEssence, ItemName.Gaea_Essence),
    ...
    LocationData(base_id + 134, LocationName.LavaGrotto_IgniEssence, ItemName.Igni_Essence),
...
events = [
    LocationData(None, LocationName.MystralWoodsMidBoss, ItemName.DefeatGoblinChampion, LocationType.Event, True),
    LocationData(None, LocationName.MystralWoodsBoss, ItemName.DefeatWoodWretch, LocationType.Event, True),
    LocationData(None, LocationName.SkyTempleBoss, ItemName.DefeatSleet, LocationType.Event, True),
    LocationData(None, LocationName.TombOfTheMageKing_GhostQueen, ItemName.DefeatGhostQueen, LocationType.Event, True),
    LocationData(None, LocationName.GreyleafHamletSageOfAura, ItemName.MeetSageOfAura, LocationType.Event, True),
    LocationData(None, LocationName.SunkenQuarrySageOfAqua, ItemName.MeetSageOfAqua, LocationType.Event, True),
    LocationData(None, LocationName.OldMinesSageOfGaea, ItemName.MeetSageOfGaea, LocationType.Event, True),
    LocationData(None, LocationName.LavaGrottoSageOfIgni, ItemName.MeetSageOfIgni, LocationType.Event, True),
    ...
    LocationData(None, LocationName.GreyleafHamlet_RachelMarieQuest, ItemName.BagOfWaresReturned, LocationType.Event, True),
