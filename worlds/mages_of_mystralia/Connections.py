...
[
    ...
    ConnectionData(EntranceName.MystralWoods_Lardee, RegionName.MystralWoodsLardeeArea),
    ...
    ConnectionData(EntranceName.MystralWoodsDeepWoods_GreyleafHamletNorth, RegionName.Greyleaf_Hamlet_North),
